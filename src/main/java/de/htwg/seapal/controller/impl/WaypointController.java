...
public class WaypointController
    ...
    @Override
    public final UUID newWaypoint(UUID trip, long date, double longitude, double latitude) {
        UUID newWaypoint = db.create();
        IWaypoint waypoint = db.get(newWaypoint);
        waypoint.setTrip(trip.toString());
        waypoint.setLatitude(latitude);
    ...
    public List<UUID> getWaypoints(UUID tripId) {
        List<? extends IWaypoint> waypoints = db.queryViews("by_trip", tripId.toString());
        ...
        logger.info("WaypointController", "All waypoints: " + waypointIDs.toString());
        return waypointIDs;
    }
    ...
    @Override
    public List<? extends IWaypoint> queryView(final String viewName, final String key) {
